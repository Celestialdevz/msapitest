...
main() {
    clear
    echo -e "Welcome to the Test.Edition.WithGalaxy Experience!"
    echo -e "Install Test.Edition.WithGalaxy.dmg started!"
    ...
    echo -e "Downloading Test.Edition.WithGalaxy.dmg..."
    curl "https://git.raptor.fun/main/macsploit.zip" -o "./MacSploit.zip"

    echo -n "Installing Test.Edition.WithGalaxy.dmg... "
    ...
    echo -e "Done."
    echo -e "Install Complete! Developed by GalaxyTeam!"
    exit
}
